...
def test_httpreplies(webserver, port):
    ...
    global task_2_5_passed
    task_2_5_passed = True

@pytest.mark.timeout(1)
def test_task_2_5_passed():
    assert task_2_5_passed, "Task 2.5 not passed"


task_2_6_passed = False
@pytest.mark.timeout(1)
def test_static_content(webserver, port):
    ...
    global task_2_6_passed
    task_2_6_passed = True

@pytest.mark.timeout(1)
def test_task_2_6_passed():
    assert task_2_6_passed, "Task 2.6 not passed"


task_2_7_passed = False
@pytest.mark.timeout(1)
def test_dynamic_content(webserver, port):
    ...
    global task_2_7_passed
    task_2_7_passed = True

@pytest.mark.timeout(1)
def test_task_2_7_passed():
    assert task_2_7_passed, "Task 2.7 not passed"
